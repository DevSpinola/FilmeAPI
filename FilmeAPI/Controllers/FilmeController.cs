...
public class FilmeController : ControllerBase
{
    ...
    {
        if(nomeCinema == null) return _mapper.Map<List<ReadFilmeDto>>(_context.Filmes.Skip(skip).Take(take).ToList());
        else return _mapper.Map<List<ReadFilmeDto>>(_context.Filmes.Skip(skip).Take(take).
